def get_evaluation_configurations():
    ...
    base_config = {
        "logging": {
            "log_dir": "/home/ubuntu/01.Stanford/01.CS224N/01.Project/13.Sophia_Adam_LoRA_MBPP_APPS_pass@1_Scripts/logs",
        },
        "output": {
            "results_dir": "/home/ubuntu/01.Stanford/01.CS224N/01.Project/13.Sophia_Adam_LoRA_MBPP_APPS_pass@1_Scripts/results_all",
        },
        "tracking": {
            "file": "/home/ubuntu/01.Stanford/01.CS224N/01.Project/07.Tracking/lora_round2_sophia_adam_evals_tracking.csv",
        ...
        "lora_model": {
            "path": "/home/ubuntu/01.Stanford/01.CS224N/01.Project/08.Models/20250305_wrf_MBPP2APPS_adamw_r8_lr0.0002_epochs3_merged_round2_GOLD",
        },
        "evaluation": {
            "task": "human_eval",
            "metric": "pass@1",
...
######### NOTE: 2 different LORA Models - on initial and second finetuned on APPS with adam/sophia
# /home/ubuntu/01.Stanford/01.CS224N/01.Project/08.Models/20250301_03_alpha16_dropout0.05_r8_lr0.0002_epochs3    --> original lora model with highest score
# /home/ubuntu/01.Stanford/01.CS224N/01.Project/08.Models/20250304_orr_MBPP2APPS_adamw_r8_|r0.0002_epochs3 ---> second lora model trained on adam & APPS
# New LORA round2/round 1 trained model 01.Stanford/01.CS224N/01.Project/08.Models/20250305_wrf_MBPP2APPS_adamw_r8_lr0.0002_epochs3_merged_round2_GOLD 
...
######### New Set of 50 --- 10 per mdoel #######################
    ...
    ###################### Completed ########################## #35.98 (QKV model - Diversity penalty) 
    config_m8_5 = deep_copy_config(base_config) 
